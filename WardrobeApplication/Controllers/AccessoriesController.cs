...
namespace WardrobeApplication.Controllers
{
    public class AccessoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AccessoryID,Description,Color,Season,Occasion,Photo")] Accessory accessory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AccessoryID,Description,Color,Season,Occasion,Photo")] Accessory accessory)
        {
            if (ModelState.IsValid)
            {
