...
namespace WardrobeApplication.Controllers
{
    public class TopsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TopID,Description,Color,Season,Occasion,Photo")] Top top)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TopID,Description,Color,Season,Occasion,Photo")] Top top)
        {
            if (ModelState.IsValid)
            {
