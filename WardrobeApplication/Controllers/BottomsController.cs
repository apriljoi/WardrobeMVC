...
namespace WardrobeApplication.Controllers
{
    public class BottomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomID,Description,Color,Season,Occasion,Photo")] Bottom bottom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomID,Description,Color,Season,Occasion,Photo")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
